...
<font size="5">This package includs all features that has been extracted from Position-Specific Scoring Matrix (PSSM) in POSSUM website: http://possum.erc.monash.edu/ and some of other features
from several articles. each function in this package corresponds to one feature that has extracted from PSSM Matrix.</font>
...
![](vignettes/figures/screens/dpc.JPG)
...
![](vignettes/figures/screens/k_separated.JPG)
